...
{
	public class Eq9ModelProviderForStaggeredSolutionex5
    {
        ...
        public Eq9ModelProviderForStaggeredSolutionex5(ComsolMeshReader comsolReader, double sc, double miNormal, double kappaNormal, double miTumor,
