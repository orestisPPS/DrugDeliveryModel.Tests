...
{
	public class Eq9ModelProviderForStaggeredSolutionex32
    {
        ...
        public Eq9ModelProviderForStaggeredSolutionex32(ComsolMeshReader comsolReader, double sc, double miNormal, double kappaNormal, double miTumor,
