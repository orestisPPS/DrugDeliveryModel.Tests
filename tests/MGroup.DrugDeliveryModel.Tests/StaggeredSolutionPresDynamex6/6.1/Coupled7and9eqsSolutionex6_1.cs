...
namespace MGroup.DrugDeliveryModel.Tests.Integration
{
    public class Coupled7and9eqsSolutionex6_1
    {
        ...
        private const double timeStep = 2.5e-4; // in sec
        ...
        static double structuralMonitorNodeX = 0.1;
        static double structuralMonitorNodeY = 0.05;
        static double structuralMonitorNodeZ = 0.05;
        ...
        public void MonophasicEquationModel(string fileName)
        {
            ...
            var eq78Model = new Eq78ModelProviderForStaggeredSolutionex6_1(comsolReader, k_th, Lp, Sv, pv, LplSvl, pl,
                velocityDivergenceAtElementGaussPoints, boundaryValueAllBoundaries, initialCondition, pressureMonitorID, eq7n8dofTypeToMonitor, modelMinX,
            ...
            CSVExporter.ExportVectorToCSV(p_i, "../../../StaggeredSolutionPresDynamex6/6.1/pi_nodes_mslv.csv");
