...
namespace MGroup.DrugDeliveryModel.Tests.Integration
{
	public class Coupled7and9eqsSolutionex6
    {
        ...
        public void MonophasicEquationModel(string fileName)
		{
           ...
           var eq78model = new Eq78ModelProviderForStaggeredSolutionex6(comsolReader, k_th, Lp, Sv, pv, LplSvl, pl, velocityDivergenceAtElementGaussPoints, 
            ...
            var eq9model = new Eq9ModelProviderForStaggeredSolutionex6(comsolReader, Sc, miNormal, kappaNormal, miTumor, kappaTumor, timeStep, totalTime, lambda, pressureTensorDivergenceAtElementGaussPoints,
            ...
            (new MGroup.LinearAlgebra.Output.Array1DWriter()).WriteToFile(structuralResultsX, $@"C:\Users\acivi\Documents\atuxaia\develop yperelastic withh BIO TEAM\VALIDATION EQs1\staggered_ex6\pressure_{pr}_F_{Fval}_e{Fval_e}_LOGGEDval_u_{1}_.txt");
            (new MGroup.LinearAlgebra.Output.Array1DWriter()).WriteToFile(structuralResultsY, $@"C:\Users\acivi\Documents\atuxaia\develop yperelastic withh BIO TEAM\VALIDATION EQs1\staggered_ex6\pressure_{pr}_F_{Fval}_e{Fval_e}_LOGGEDval_u_{2}_.txt");
            (new MGroup.LinearAlgebra.Output.Array1DWriter()).WriteToFile(structuralResultsZ, $@"C:\Users\acivi\Documents\atuxaia\develop yperelastic withh BIO TEAM\VALIDATION EQs1\staggered_ex6\pressure_{pr}_F_{Fval}_e{Fval_e}_LOGGEDval_u_{3}_.txt");
            (new MGroup.LinearAlgebra.Output.Array1DWriter()).WriteToFile(modelMaxVelDivOverTime, $@"C:\Users\acivi\Documents\atuxaia\develop yperelastic withh BIO TEAM\VALIDATION EQs1\staggered_ex6\pressure_{pr}_F_{Fval}_e{Fval_e}_LOGGEDval_modelMaxVelDivOverTime.txt");
            (new MGroup.LinearAlgebra.Output.Array1DWriter()).WriteToFile(structuralResultsZ, $@"C:\Users\acivi\Documents\atuxaia\develop yperelastic withh BIO TEAM\VALIDATION EQs1\staggered_ex6\pressure_{pr}_F_{Fval}_e{Fval_e}_LOGGEDval_modelMax_dP_dx{3}OverTime.txt");
