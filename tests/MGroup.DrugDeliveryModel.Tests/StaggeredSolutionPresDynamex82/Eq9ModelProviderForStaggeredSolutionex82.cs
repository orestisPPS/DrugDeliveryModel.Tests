...
{
	public class Eq9ModelProviderForStaggeredSolutionex82
    {
        ...
        public Eq9ModelProviderForStaggeredSolutionex82(ComsolMeshReader comsolReader, double sc, double miNormal, double kappaNormal, double miTumor,
