...
{
	public class Eq9ModelProviderForStaggeredSolutionex81
    {
        ...
        public Eq9ModelProviderForStaggeredSolutionex81(ComsolMeshReader comsolReader, double sc, double miNormal, double kappaNormal, double miTumor,
