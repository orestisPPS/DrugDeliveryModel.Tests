...
{
	public class Eq9ModelProviderForStaggeredSolutionex4
    {
        ...
        public Eq9ModelProviderForStaggeredSolutionex4(ComsolMeshReader comsolReader, double sc, double miNormal, double kappaNormal, double miTumor,
