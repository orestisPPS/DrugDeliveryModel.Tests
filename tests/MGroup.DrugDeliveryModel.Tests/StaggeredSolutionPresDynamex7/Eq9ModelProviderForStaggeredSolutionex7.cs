...
{
	public class Eq9ModelProviderForStaggeredSolutionex7
    {
        ...
        public Eq9ModelProviderForStaggeredSolutionex7(ComsolMeshReader comsolReader, double sc, double miNormal, double kappaNormal, double miTumor,
