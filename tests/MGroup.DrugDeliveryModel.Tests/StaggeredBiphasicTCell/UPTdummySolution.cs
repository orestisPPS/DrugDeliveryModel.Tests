    ...
    public class UPTdummySolution
    {
        ...
        #region Cancer Cell Density (TCell) Boundary Conditions
            ...
            private static List<(BC, ConvectionDiffusionDof[], double[][], double[])> tCellDirichletBC =
                ...
                {
                    (BC.TopDirichlet, constrainedDofType, new double[1][]{new double[3] {0,0,0.1}}, TcellBoundaryValue),
                    (BC.LeftDirichlet, constrainedDofType, new double[1][]{new double[3] {0.1,0,0}}, TcellBoundaryValue),
                    (BC.FrontDirichlet, constrainedDofType, new double[1][]{new double[3] {0,0,0}}, TcellBoundaryValue),
                };
